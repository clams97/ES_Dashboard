...
PLOTLY_LOGO = Image.open("logo.png")
#PLOTLY_LOGO = Image.open("C:/Users/andre/Desktop/Project_2/assets/logo.png")
menu = Image.open("menu_2.png")
#menu = Image.open("C:/Users/andre/Desktop/Project_2/assets/menu_2.png")
#home_background = Image.open("assets/data_science.jpg")
#home_background = Image.open("C:/Users/andre/Desktop/Project_2/assets/data_science.jpg")
...
# Defining a function to round numbers accordingly to a certain number of decimal values
...
def generate_total_plot(start_date, end_date, value):
    ...
    #fig1.update_layout(title={'text': "Clusters 3D Visualization", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date")
    return fig1
...
###########################################_____EXPLORATORY DATA_____###################################################
#df_anim = px.data.gapminder()
#animation = {
#    'Scatter': px.scatter(
#        df_anim, x="gdpPercap", y="lifeExp", animation_frame="year",
...
#fig4.update_layout(
#    title={'text': "Performance Based on the Number of Clusters",'y':0.95,'x':0.5,'xanchor': 'center','yanchor': 'top'})

#plotly.io.write_json(fig=fig4, file="assets/optimal_num_clusters")
fig4=plotly.io.read_json("assets/optimal_num_clusters", output_type='Figure')
...
def kmeans_pie(column_1, num_clusters=4):
  ...
  fig5.update_layout(title={'text': "Data Density by Clusters",'y': 0.95,'x': 0.5,'xanchor': 'center','yanchor': 'top'})
  return fig5
...
def kmeans_scatter2d(column_1, column_2, num_clusters=4):
  ...
  fig6.update_layout(title={'text': "Clusters 2D Visulaization",'y': 0.95,'x': 0.5,'xanchor': 'center','yanchor': 'top'})
  return fig6
...
plotly.io.write_json(fig=fig8, file="assets/sillhoute")
fig8=plotly.io.read_json("assets/sillhoute", output_type='Figure')
...
fig10.update_layout(title={'text': "Data Distribution by Clusters - KBest f_Regression", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Features", yaxis_title="Dependency level")
...
fig11.update_layout(title={'text': "Data Distribution by Clusters - KBest Mutual_Info_Regression", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Features", yaxis_title="Dependency level")
...
fig12.update_layout(title={'text': "Data Distribution by Clusters - Linear Regression ", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Features", yaxis_title="Dependency level")
...
fig13.update_layout(title={'text': "Data Distribution by Clusters - Random Forest Regressor", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Features", yaxis_title="Dependency level")
...
#Save model
#pickle.dump(regr, open('assets/LR_model', 'wb'))
# Load from file
regr = pickle.load(open('assets/LR_model', 'rb'))
...
fig14.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
fig14.add_trace(go.Scatter(y=y_pred_LR[1:200], mode="lines"))
fig14.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig15=px.scatter(x=y_test,y=y_pred_LR)
fig15.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")
...
# Save model
#pickle.dump(regr, open('assets/regr_model', 'wb'))
# Load from file
regr= pickle.load(open('assets/regr_model', 'rb'))
...
#Visualization
fig16=go.Figure()
fig16.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig16 = px.line(y=y_test[1:200])
fig16.add_trace(go.Scatter(y=y_pred_SVR2[1:200], mode="lines"))
fig16.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig17=px.scatter(x=y_test,y=y_pred_SVR2)
fig17.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")
...
# Save model
#pickle.dump(DT_regr_model, open('assets/DT_model', 'wb'))
# Load from file
DT_regr_model = pickle.load(open('assets/DT_model', 'rb'))
...
#Visualization
fig18=go.Figure()
fig18.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig18 = px.line(y=y_test[1:200])
fig18.add_trace(go.Scatter(y=y_pred_DT[1:200], mode="lines"))
fig18.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig19=px.scatter(x=y_test,y=y_pred_DT)
fig19.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")
...
# Save model
#pickle.dump(RF_model, open('assets/RF_model', 'wb'))
# Load from file
RF_model = pickle.load(open('assets/RF_model', 'rb'))
...
#Visualization
fig20=go.Figure()
fig20.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig20 = px.line(y=y_test[1:200])
fig20.add_trace(go.Scatter(y=y_pred_RF[1:200], mode="lines"))
fig20.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig21=px.scatter(x=y_test,y=y_pred_RF)
fig21.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")
...
# Save model
#pickle.dump(GB_model, open('assets/GB_model', 'wb'))
# Load from file
GB_model = pickle.load(open('assets/GB_model', 'rb'))
...
#Visualization
fig22=go.Figure()
fig22.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig22 = px.line(y=y_test[1:200])
fig22.add_trace(go.Scatter(y=y_pred_GB[1:200], mode="lines"))
fig22.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig23=px.scatter(x=y_test,y=y_pred_GB)
fig23.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")
...
# Save model
#pickle.dump(XGB_model, open('assets/XGB_model', 'wb'))
# Load from file
XGB_model = pickle.load(open('assets/XGB_model', 'rb'))
...
#Visualization
fig24=go.Figure()
fig24.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig24 = px.line(y=y_test[1:200])
fig24.add_trace(go.Scatter(y=y_pred_XGB[1:200], mode="lines"))
fig24.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig25=px.scatter(x=y_test,y=y_pred_XGB)
fig25.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")
...
# Save model
#pickle.dump(BT_model, open('assets/BT_model', 'wb'))
# Load from file
BT_model = pickle.load(open('assets/BT_model', 'rb'))

y_pred_BT =BT_model.predict(X_test)

with open('assets/y_pred_BT', 'wb') as file_pi:
    pickle.dump(y_pred_BT, file_pi)

# Load from file
with open("assets/y_pred_BT", 'rb') as file_pi:
    y_pred_BT = pickle.load(file_pi)
...
#Visualization
fig26=go.Figure()
fig26.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig26 = px.line(y=y_test[1:200])
fig26.add_trace(go.Scatter(y=y_pred_BT[1:200], mode="lines"))
fig26.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig27=px.scatter(x=y_test,y=y_pred_BT)
fig27.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")
...
#NN_model_sk = MLPRegressor(hidden_layer_sizes=(10,10,10,10))
#NN_model_sk.fit(X_train,y_train)


#with open("NN_model_sk.pkl", 'wb') as file:
#    pickle.dump(NN_model_sk, file)

# Load from file
with open("assets/NN_model_sk.pkl", 'rb') as file:
    NN_model_sk = pickle.load(file)

y_pred_NN = NN_model_sk.predict(X_test)

with open('assets/y_pred_SK', 'wb') as file_pi:
    pickle.dump(y_pred_NN, file_pi)

# Load from file
with open("assets/y_pred_SK", 'rb') as file_pi:
    y_pred_NN = pickle.load(file_pi)
...
#Visualization
fig28=go.Figure()
fig28.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig28 = px.line(y=y_test[1:200])
fig28.add_trace(go.Scatter(y=y_pred_NN[1:200], mode="lines"))
fig28.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig29=px.scatter(x=y_test,y=y_pred_NN)
fig29.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")

df_metrics_SK_NN=pd.DataFrame({'MAE': [MAE_NN], 'MSE': [MSE_NN], "RMSE":[RMSE_NN], "cvRMSE":[cvRMSE_NN]})
#tab_total_SK_NN = dash_table.DataTable(
#        data=df_metrics.to_dict('records'),
#        columns=[{'id': c, 'name': c} for c in df_metrics],
#        virtualization=True,
#        fixed_rows={'headers': True},
...
###############______Baseline Neural Network________##################
# Validation data: 10% of the trainning set
X_valid, y_valid = X_train[:1300], y_train[:1300]
X1_train, y1_train = X_train[1300:], y_train[1300:]

# Create a Sequential model: Sequential model is the simpliest kind of keras model
#                            for neural networks that are just composed of a single
#                            stack of layers connected sequentially
#NN_model = Sequential()
#NN_model.add(Dense(5, input_dim=5, activation='relu'))
#NN_model.add(Dense(1)) # No activation function is used for the output layer because it is a regression problem and we are interested in predicting numerical values directly without transform.

# Compile model
#NN_model.compile(loss='mean_squared_error', optimizer="adam")
# Training the model
#history = NN_model.fit(X1_train, y1_train, epochs = 20, validation_data = (X_valid, y_valid), verbose=0)

#with open('assets/history_KNN1', 'wb') as file_pi:
#    pickle.dump(history.history, file_pi)

# Load from file
with open("assets/history_KNN1", 'rb') as file_pi:
    history = pickle.load(file_pi)

#Save model
#NN_model.save("assets/NN_model_KNN1.h5")

#Load model
NN_model_KNN1=load_model("assets/NN_model_KNN1.h5")

# Evaluate the model
mse_test = NN_model_KNN1.evaluate(X_test, y_test)

# Using the model to make predictions
y_pred_NN = NN_model_KNN1.predict(X_test)

with open('assets/y_pred_KNN1', 'wb') as file_pi:
    pickle.dump(y_pred_NN, file_pi)

# Load from file
with open("assets/y_pred_KNN1", 'rb') as file_pi:
    y_pred_NN = pickle.load(file_pi)

# Prediction Metrics
MAE_KNN1=metrics.mean_absolute_error(y_test,y_pred_NN)
MSE_KNN1=metrics.mean_squared_error(y_test,y_pred_NN)
RMSE_KNN1= np.sqrt(metrics.mean_squared_error(y_test,y_pred_NN))
cvRMSE_KNN1=RMSE_KNN1/np.mean(y_test)

#Visualization
fig30=go.Figure()
fig30.add_trace(go.Scatter(y=pd.DataFrame(history)["loss"], mode="lines"))
#fig30=px.line(y=pd.DataFrame(history.history)["loss"])
fig30.add_trace(go.Scatter(y=pd.DataFrame(history)["val_loss"], mode="lines"))
fig31=go.Figure()
fig31.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig31 = px.line(y=y_test[1:200])
fig31.add_trace(go.Scatter(y=y_pred_NN[1:200].T[0], mode="lines"))
fig32=px.scatter(x=y_test,y=y_pred_NN.T[0])

fig30.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Episodes", yaxis_title="Score")
fig31.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig32.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")

df_metrics_KNN1=pd.DataFrame({'MAE': [MAE_KNN1], 'MSE': [MSE_KNN1], "RMSE":[RMSE_KNN1], "cvRMSE":[cvRMSE_KNN1]})
#tab_total_KNN1 = dash_table.DataTable(
#        data=df_metrics.to_dict('records'),
#        columns=[{'id': c, 'name': c} for c in df_metrics],
#        virtualization=True,
#        fixed_rows={'headers': True},
...
###############____Neural Network with Standardized Dataset______##################
# Validation data: 10% of the trainning set
#X_valid, y_valid = X_train[:1300], y_train[:1300]
#X1_train, y1_train = X_train[1300:], y_train[1300:]
...
#NN_model_1.add(Dense(30, input_shape=X1_train_sc.shape[1:], activation='relu'))
#NN_model_1.add(Dense(1)) # No activation function is used for the output layer because it is a regression problem and we are interested in predicting numerical values directly without transform.

# Compile model
#NN_model_1.compile(loss='mean_squared_error', optimizer="adam")
# Training the model
#history = NN_model_1.fit(X1_train_sc, y1_train, epochs = 20, validation_data = (X_valid_sc, y_valid), verbose=0)

#with open('assets/history_KNN2', 'wb') as file_pi:
#    pickle.dump(history.history, file_pi)

# Load from file
with open("assets/history_KNN2", 'rb') as file_pi:
    history = pickle.load(file_pi)

#Save model
#NN_model_1.save("assets/NN_model_KNN2.h5")

#Load model
NN_model_KNN2=load_model("assets/NN_model_KNN2.h5")

# Evaluate the model
mse_test = NN_model_KNN2.evaluate(X_test, y_test)

# Using the model to make predictions
y_pred_NN = NN_model_KNN2.predict(X_test_sc)

with open('assets/y_pred_KNN2', 'wb') as file_pi:
    pickle.dump(y_pred_NN, file_pi)

# Load from file
with open("assets/y_pred_KNN2", 'rb') as file_pi:
    y_pred_NN = pickle.load(file_pi)

# Prediction Metrics
MAE_KNN2=metrics.mean_absolute_error(y_test,y_pred_NN)
MSE_KNN2=metrics.mean_squared_error(y_test,y_pred_NN)
RMSE_KNN2= np.sqrt(metrics.mean_squared_error(y_test,y_pred_NN))
cvRMSE_KNN2=RMSE_KNN2/np.mean(y_test)


#Visualization
fig33=go.Figure()
fig33.add_trace(go.Scatter(y=pd.DataFrame(history)["loss"], mode="lines"))
#fig33=px.line(y=pd.DataFrame(history.history)["loss"])
fig33.add_trace(go.Scatter(y=pd.DataFrame(history)["val_loss"], mode="lines"))
fig34=go.Figure()
fig34.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig34 = px.line(y=y_test[1:200])
fig34.add_trace(go.Scatter(y=y_pred_NN[1:200].T[0], mode="lines"))
fig35=px.scatter(x=y_test,y=y_pred_NN.T[0])

fig33.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Episodes", yaxis_title="Score")
fig34.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig35.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")

df_metrics_KNN2=pd.DataFrame({'MAE': [MAE_KNN2], 'MSE': [MSE_KNN2], "RMSE":[RMSE_KNN2], "cvRMSE":[cvRMSE_KNN2]})
#tab_total_KNN2 = dash_table.DataTable(
#        data=df_metrics.to_dict('records'),
#        columns=[{'id': c, 'name': c} for c in df_metrics],
#        virtualization=True,
#        fixed_rows={'headers': True},
...
###############_____Deep Neural Network with Standardized Dataset, Early stopping, Adamax optimizer______##################
# Validation data: 10% of the trainning set
#X_valid, y_valid = X_train[:1300], y_train[:1300]
#X1_train, y1_train = X_train[1300:], y_train[1300:]
...
#                            stack of layers connected sequentially
#NN_model_1 = Sequential()
#NN_model_1.add(Dense(300, input_shape=X1_train_sc.shape[1:], activation='relu'))
#NN_model_1.add(Dense(200,  activation='relu'))
#NN_model_1.add(Dense(100,  activation='relu'))
#NN_model_1.add(Dense(1)) # No activation function is used for the output layer because it is a regression problem and we are interested in predicting numerical values directly without transform.

# Compile model
#NN_model_1.compile(loss='mean_squared_error', optimizer="adamax")

# Early stopping
#es = keras.callbacks.EarlyStopping(monitor='val_loss', mode='min', verbose=1)

# Training the model
#history = NN_model_1.fit(X1_train_sc, y1_train, epochs = 100, validation_data = (X_valid_sc, y_valid), verbose=0,)# callbacks=[es])

#with open('assets/history_KNN3', 'wb') as file_pi:
#    pickle.dump(history.history, file_pi)

# Load from file
with open("assets/history_KNN3", 'rb') as file_pi:
    history = pickle.load(file_pi)

#Save model
#NN_model_1.save("assets/NN_model_KNN3.h5")

#Load model
NN_model_KNN3=load_model("assets/NN_model_KNN3.h5")

# Evaluate the model
mse_test = NN_model_KNN3.evaluate(X_test, y_test)

# Using the model to make predictions
y_pred_NN = NN_model_KNN3.predict(X_test_sc)

with open('assets/y_pred_KNN3', 'wb') as file_pi:
    pickle.dump(y_pred_NN, file_pi)

# Load from file
with open("assets/y_pred_KNN3", 'rb') as file_pi:
    y_pred_NN = pickle.load(file_pi)

# Prediction Metrics
MAE_KNN3=metrics.mean_absolute_error(y_test,y_pred_NN)
MSE_KNN3=metrics.mean_squared_error(y_test,y_pred_NN)
RMSE_KNN3= np.sqrt(metrics.mean_squared_error(y_test,y_pred_NN))
cvRMSE_KNN3=RMSE_KNN3/np.mean(y_test)

#Visualization
fig36=go.Figure()
fig36.add_trace(go.Scatter(y=pd.DataFrame(history)["loss"], mode="lines"))
#fig36=px.line(y=pd.DataFrame(history.history)["loss"])
fig36.add_trace(go.Scatter(y=pd.DataFrame(history)["val_loss"], mode="lines"))
fig37=go.Figure()
fig37.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig37 = px.line(y=y_test[1:200])
fig37.add_trace(go.Scatter(y=y_pred_NN[1:200].T[0], mode="lines"))
fig38=px.scatter(x=y_test,y=y_pred_NN.T[0])

fig36.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Episodes", yaxis_title="Score")
fig37.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig38.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")

df_metrics_KNN3=pd.DataFrame({'MAE': [MAE_KNN3], 'MSE': [MSE_KNN3], "RMSE":[RMSE_KNN3], "cvRMSE":[cvRMSE_KNN3]})
#tab_total_KNN3 = dash_table.DataTable(
#        data=df_metrics.to_dict('records'),
#        columns=[{'id': c, 'name': c} for c in df_metrics],
#        virtualization=True,
#        fixed_rows={'headers': True},
...
######_____Deep Neural Network with Standardized Dataset, Early stopping, Nadam optimizer________#########
...
# Compile model
#NN_model_1.compile(loss='mean_squared_error', optimizer="nadam")
...
#with open('assets/history_KNN4', 'wb') as file_pi:
#    pickle.dump(history.history, file_pi)

# Load from file
with open("assets/history_KNN4", 'rb') as file_pi:
    history = pickle.load(file_pi)

#Save model
#NN_model_1.save("assets/NN_model_KNN4.h5")

#Load model
NN_model_KNN4=load_model("assets/NN_model_KNN4.h5")

# Evaluate the model
mse_test = NN_model_KNN4.evaluate(X_test, y_test)

# Using the model to make predictions
y_pred_NN = NN_model_KNN4.predict(X_test_sc)

with open('assets/y_pred_KNN4', 'wb') as file_pi:
    pickle.dump(y_pred_NN, file_pi)

# Load from file
with open("assets/y_pred_KNN4", 'rb') as file_pi:
    y_pred_NN = pickle.load(file_pi)

# Prediction Metrics
MAE_KNN4=metrics.mean_absolute_error(y_test,y_pred_NN)
MSE_KNN4=metrics.mean_squared_error(y_test,y_pred_NN)
RMSE_KNN4= np.sqrt(metrics.mean_squared_error(y_test,y_pred_NN))
cvRMSE_KNN4=RMSE_KNN4/np.mean(y_test)

#Visualization
fig39=go.Figure()
fig39.add_trace(go.Scatter(y=pd.DataFrame(history)["loss"], mode="lines"))
#fig39=px.line(y=pd.DataFrame(history.history)["loss"])
fig39.add_trace(go.Scatter(y=pd.DataFrame(history)["val_loss"], mode="lines"))
fig40=go.Figure()
fig40.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig40 = px.line(y=y_test[1:200])
fig40.add_trace(go.Scatter(y=y_pred_NN[1:200].T[0], mode="lines"))
fig41=px.scatter(x=y_test,y=y_pred_NN.T[0])

fig39.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Episodes", yaxis_title="Score")
fig40.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig41.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")

df_metrics_KNN4=pd.DataFrame({'MAE': [MAE_KNN4], 'MSE': [MSE_KNN4], "RMSE":[RMSE_KNN4], "cvRMSE":[cvRMSE_KNN4]})
#tab_total_KNN4 = dash_table.DataTable(
#        data=df_metrics.to_dict('records'),
#        columns=[{'id': c, 'name': c} for c in df_metrics],
#        virtualization=True,
#        fixed_rows={'headers': True},
...
####_________Deep Neural Network with Standardized Dataset, Early stopping, RMSprop optimizer_________###########
# Validation data: 10% of the trainning set
#X_valid, y_valid = X_train[:1300], y_train[:1300]
#X1_train, y1_train = X_train[1300:], y_train[1300:]
...
# Compile model
#NN_model_1.compile(loss='mean_squared_error', optimizer="rmsprop")
...
#with open('assets/history_KNN5', 'wb') as file_pi:
#    pickle.dump(history.history, file_pi)

# Load from file
with open("assets/history_KNN5", 'rb') as file_pi:
    history = pickle.load(file_pi)

#Save model
#NN_model_1.save("assets/NN_model_KNN5.h5")

#Load model
NN_model_KNN5=load_model("assets/NN_model_KNN5.h5")

# Evaluate the model
mse_test = NN_model_KNN5.evaluate(X_test, y_test)

# Using the model to make predictions
y_pred_NN = NN_model_KNN5.predict(X_test_sc)

with open('assets/y_pred_KNN5', 'wb') as file_pi:
    pickle.dump(y_pred_NN, file_pi)

# Load from file
with open("assets/y_pred_KNN5", 'rb') as file_pi:
    y_pred_NN = pickle.load(file_pi)

# Prediction Metrics
MAE_KNN5=metrics.mean_absolute_error(y_test,y_pred_NN)
MSE_KNN5=metrics.mean_squared_error(y_test,y_pred_NN)
RMSE_KNN5= np.sqrt(metrics.mean_squared_error(y_test,y_pred_NN))
cvRMSE_KNN5=RMSE_KNN5/np.mean(y_test)

#Visualization
fig42=go.Figure()
fig42.add_trace(go.Scatter(y=pd.DataFrame(history)["loss"], mode="lines"))
#fig42=px.line(y=pd.DataFrame(history.history)["loss"])
fig42.add_trace(go.Scatter(y=pd.DataFrame(history)["val_loss"], mode="lines"))
fig43=go.Figure()
fig43.add_trace(go.Scatter(y=y_test[1:200], mode="lines"))
#fig43 = px.line(y=y_test[1:200])
fig43.add_trace(go.Scatter(y=y_pred_NN[1:200].T[0], mode="lines"))
fig44=go.Figure()
fig44=px.scatter(x=y_test,y=y_pred_NN.T[0])

fig42.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Episodes", yaxis_title="Score")
fig43.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="Date", yaxis_title="y_test & y_predicted")
fig44.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'}, xaxis_title="y_test", yaxis_title="y_predicted")

df_metrics_KNN5=pd.DataFrame({'MAE': [MAE_KNN5], 'MSE': [MSE_KNN5], "RMSE":[RMSE_KNN5], "cvRMSE":[cvRMSE_KNN5]})
#tab_total_KNN5 = dash_table.DataTable(
#        data=df_metrics.to_dict('records'),
#        columns=[{'id': c, 'name': c} for c in df_metrics],
#        virtualization=True,
#        fixed_rows={'headers': True},
    ...
    #    return \
        ...
        return html.Div([
                dcc.Tabs(id='tabs_nn', value='tab-12', children=[
                    ...
                    dcc.Tab(label='Keras NN, Adam Optimizer', value='tab-13',), #className='os-tab'), #style=TAB_STYLE, selected_style = SELECTED_STYLE),
                    dcc.Tab(label='Keras NN, Standardized Data, Adam Optimizer', value='tab-14', ),
                    dcc.Tab(label='Keras DNN, Standardized Data, Adamax Optimizer', value='tab-15', ),
                    dcc.Tab(label='Keras DNN,  Standardized Data, Nadam Optimizer', value='tab-16', ),
                    dcc.Tab(label='Keras DNN,  Standardized Data, RMSprop Optimizer', value='tab-17', ),
                ],
                         colors={
                             "border": "Gray",
                             "primary": "blue",
    ...
    if tab == 'tab-3':
        ...
        return html.Div([
            ...
            html.Div(
                ...
                ], style=dict(display='flex'),  # style={'marginBottom': 30}
            ),
...
def render_content_nn(tab):
    ...
    if tab == 'tab-13':
        return html.Div([
            ...
            html.Div([
                ...
                html.Div(
                    dcc.Graph(id='g30',
                              figure=fig30,
                              style={"margin-left": "15px", "margin-right": "5px"}),
                    style={"width": "33%", "left-margin": 10, 'display': 'inline-block'},
                    className="six columns",
                ),
                ...
                html.Div(
                    dcc.Graph(id='g31',
                              ...
                              style={"margin-left": "5px", "margin-right": "15px"}),
                    className="six columns",
                    style={"width": "33%", "right-margin": 10, 'display': 'inline-block'}
                ),
            ...
            html.Div([
                generate_table(df_metrics_KNN1)
            ], style={'margin-top': 5, "width": "100%"}),
    ...
    if tab == 'tab-14':
        return html.Div([
            ...
            html.Div([
                generate_table(df_metrics_KNN2)
            ], style={'margin-top': 5, "width": "100%"}),
    ...
    if tab == 'tab-15':
        return html.Div([
            ...
            html.Div([
                generate_table(df_metrics_KNN3)
            ], style={'margin-top': 5, "width": "100%"}),
    ...
    if tab == 'tab-16':
        return html.Div([
            ...
            html.Div([
                generate_table(df_metrics_KNN4)
            ], style={'margin-top': 5, "width": "100%"}),
    ...
    if tab == 'tab-17':
        return html.Div([
            ...
            html.Div([
                generate_table(df_metrics_KNN5)
            ], style={'margin-top': 5, "width": "100%"}),
