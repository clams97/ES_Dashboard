...
# Compile model
#NN_model.compile(loss='mean_squared_error', optimizer=keras.optimizers.Adam(learning_rate=0.01))
NN_model.compile(loss='mean_squared_error', optimizer="adam")
# Training the model
history = NN_model.fit(X1_train, y1_train, epochs = 20, validation_data = (X_valid, y_valid), verbose=0)

# Evaluate the model
mse_test = NN_model.evaluate(X_test, y_test)
...
cvRMSE_KNN1=RMSE_NN/np.mean(y_test)

#Visualization
fig30=px.line(y=pd.DataFrame(history.history)["loss"])
fig30.add_trace(go.Scatter(y=pd.DataFrame(history.history)["val_loss"], mode="lines"))
...
fig30.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig31.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig32.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
...
# Compile model
#NN_model_1.compile(loss='mean_squared_error', optimizer=keras.optimizers.Adam(learning_rate=0.001))
...
# Evaluate the model
mse_test = NN_model_1.evaluate(X_test, y_test)

# Using the model to make predictions
y_pred_NN = NN_model_1.predict(X_test_sc)
...
cvRMSE_KNN2=RMSE_NN/np.mean(y_test)


#Visualization
fig33=px.line(y=pd.DataFrame(history.history)["loss"])
fig33.add_trace(go.Scatter(y=pd.DataFrame(history.history)["val_loss"], mode="lines"))
...
fig33.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig34.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig35.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
...
# Compile model
#NN_model_1.compile(loss='mean_squared_error', optimizer=keras.optimizers.Adamax(learning_rate=0.001))
...
cvRMSE_KNN3=RMSE_NN/np.mean(y_test)

#Visualization
fig36=px.line(y=pd.DataFrame(history.history)["loss"])
fig36.add_trace(go.Scatter(y=pd.DataFrame(history.history)["val_loss"], mode="lines"))
...
fig36.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig37.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig38.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
...
# Compile model
#NN_model_1.compile(loss='mean_squared_error', optimizer=keras.optimizers.Nadam(learning_rate=0.001))
...
cvRMSE_KNN4=RMSE_NN/np.mean(y_test)

#Visualization
fig39=px.line(y=pd.DataFrame(history.history)["loss"])
fig39.add_trace(go.Scatter(y=pd.DataFrame(history.history)["val_loss"], mode="lines"))
...
fig39.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig40.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig41.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
...
# Compile model
#NN_model_1.compile(loss='mean_squared_error', optimizer=keras.optimizers.RMSprop(learning_rate=0.001))
...
cvRMSE_KNN5=RMSE_NN/np.mean(y_test)

#Visualization
fig42=px.line(y=pd.DataFrame(history.history)["loss"])
fig42.add_trace(go.Scatter(y=pd.DataFrame(history.history)["val_loss"], mode="lines"))
...
fig42.update_layout(title={'text': "Learning Curves", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig43.update_layout(title={'text': "Actual vs Predicted Comsumption", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
fig44.update_layout(title={'text': "y_test vs y_predicted", 'y': 0.95, 'x': 0.5, 'xanchor': 'center', 'yanchor': 'top'})
...
def render_tab_clustering(tab):
    if tab == 'tab-3':
        ...
        return html.Div([
            ...
            ],style={'marginBottom': 30, 'marginTop': 20, "marginLeft": 10}),
                ...
                className="row", children=[
                    ...
                    html.Div(className='six columns', children=[
                        dcc.Dropdown(
                            ...
                            clearable=False,
                            searchable=False,
                            style={"margin-left": 7, "margin-right": 10, "margin-top": 10, "margin-bottom": 10},
                        )], style=dict(width='25%')),
            ...
            html.Div([
                ...
                html.Div(
                    ...
                    # {'data': [{'y': [1, 2, 3]}], 'layout': {'title': 'IST yearly electricity consumption (MWh)'}}),
                    style={"width": "70%", "left-margin": 10, "top-margin":20, 'display': 'inline-block'},
                    className="six columns",
                ),
                html.Div(
                    dcc.Graph(id='g6',
                    ...
                    # {'data': [{'y': [1, 2, 3]}], 'layout': {'title': 'IST yearly electricity consumption (MWh)'}}),
                    className="six columns",
                    style={"width": "30%", "right-margin": 10, "top-margin":20, 'display': 'inline-block'}
                ),
            ], className="row", style={"right-margin": 20}),
